  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        ...
        <div class="head-container">
          <el-tree :data="deptOptions" :props="{ value: 'id', label: 'shortName', children: 'children' }"
      ...
      <el-col :lg="20" :xm="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户编号" align="center" width="100" key="userName" prop="userName"
            v-if="columns.showColumn('userName')" />
          <el-table-column label="登录名" align="center" width="150" key="firstName" prop="firstName"
            v-if="columns.showColumn('firstName')" :show-overflow-tooltip="true" />
          ...
          <el-table-column label="启用" align="center" key="isActive" v-if="columns.showColumn('isActive')">
            <template #default="scope">
              <el-switch v-model="scope.row.isActive" :active-value="0" :inactive-value="1" active-text="是"
                inactive-text="否" inline-prompt></el-switch>
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
            <template #default="scope">
              ...
              <el-button text icon="Delete" @click="handleDelete(scope.row)">
              </el-button>
              <el-button text icon="Key" title="重置密码" @click="handleResetPwd(scope.row)"></el-button>
            </template>
          </el-table-column>
        </el-table>
          ...
          <el-col :lg="12">
            <el-form-item label="归属部门" prop="deptId">
              <el-tree-select v-model="form.deptId" :data="deptOptions"
                :props="{ value: 'id', label: 'shortName', children: 'children' }" value-key="id" placeholder="请选择归属部门"
...
import { changeUserStatus, listUser, resetUserPwd, delUser, getUser, updateUser, addUser, exportUser, getDepartments, } from '@/api/system/user'
...
// 列显隐信息
const columns = ref([
  { key: 0, label: `用户编号`, visible: true, prop: 'userName' },
  { key: 1, label: `用户名称`, visible: true, prop: 'firstName' },
  { key: 3, label: `部门`, visible: true, prop: 'deptName' },
  { key: 4, label: `手机号码`, visible: true, prop: 'phoneNumber' },
  { key: 5, label: `状态`, visible: true, prop: 'isActive' },
...
function getTreeselect() {
  getDepartments({ parentId: "13" }).then((response) => {
    deptOptions.value = [{ id: 0, shortName: '未知部门', children: [] }, ...response]
